...
import com.project.leaveod.dao.UpdateFromFacultyDao;

/**
 * Servlet implementation class UpdateFromFaculty
 */
@WebServlet("/UpdateFromFacultyServlet")
public class UpdateFromFacultyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	UpdateFromFacultyDao updateFromFacultyDaoObj;
    public UpdateFromFacultyServlet() {
        
    }

	public void init(ServletConfig config) throws ServletException {
		updateFromFacultyDaoObj = new UpdateFromFacultyDao();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(updateFromFacultyDaoObj.updateLeaveApplied(getFacultySelection))
		{
